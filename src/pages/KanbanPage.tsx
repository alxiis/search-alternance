  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        ...
        {outside > 0 && (
          <> {outside} offre{outside > 1 ? 's' : ''} « À analyser » ou « Archivé » ne figure{outside > 1 ? 'nt' : ''} pas ici : <Link to="/offres" className="text-accent-foreground hover:underline">voir le tableau</Link>.</>
        )}
      </p>
